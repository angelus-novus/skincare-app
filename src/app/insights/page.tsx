...
function SkeletonCard({ className = '' }: { className?: string }) {
  return (
    <div className={`bg-white rounded-2xl border border-slate-100 shadow-sm p-5 animate-pulse ${className}`}>
                ...
                <CardHeader className="bg-gradient-to-r from-rose-50 to-pink-50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">Generated by Claude</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
          ...
          <Card>
            ...
            <CardBody>
              {topIngredients.length === 0 ? (
                <p className="text-slate-400 text-sm">Rate more products to see patterns.</p>
              ) : (
          ...
          <Card>
            ...
            <CardBody>
              {lowRatedProducts.length === 0 ? (
                <p className="text-slate-400 text-sm">All your products are performing well!</p>
              ) : (
                <ul className="space-y-2">
                  {lowRatedProducts.map((p) => (
                    <li key={p.id} className="text-sm text-slate-700">
                      <span className="font-medium">{p.name}</span>
                      <span className="text-slate-400"> by {p.brand}</span>
          ...
          <Card>
            ...
            <CardBody>
              {irritantIngredients.length === 0 ? (
                <p className="text-slate-400 text-sm">No known irritants detected.</p>
              ) : (
                <ul className="space-y-2">
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">Based on your product ratings</p>
              </div>
            </div>
          </CardHeader>
          <CardBody>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  ...
                  {topIngredients.length === 0 && (
                    <span className="text-slate-400 text-sm">Rate products to see patterns</span>
                  )}
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {irritantIngredients.length === 0 && (
                    <span className="text-slate-400 text-sm">No known irritants</span>
                  )}
                </div>
              </div>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">How well your routine addresses your concerns</p>
                </div>
              </div>
            </CardHeader>
            <CardBody>
              {concernCoverage.length === 0 ? (
                <p className="text-slate-400 text-sm">Add skin concerns in your profile to see coverage.</p>
              ) : (
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-slate-800">{coveragePercent}%</p>
                  ...
                  <div className="flex-1 space-y-1.5">
                    {concernCoverage.map((c, i) => (
                      <div key={i} className="flex items-center gap-2">
                        ...
                        />
                        <span className={`text-sm ${c.covered ? 'text-slate-700' : 'text-slate-400'}`}>
                          {c.name}
                        </span>
                        {c.covered && (
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Last 30 journal entries</p>
                </div>
              </div>
            </CardHeader>
            <CardBody>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">Combinations that work well together</p>
              </div>
            </div>
          </CardHeader>
          <CardBody>
            {synergies.length === 0 ? (
              <p className="text-slate-400 text-sm">Rate more products to discover synergies.</p>
            ) : (
                ...
                {synergies.map((pair, i) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-slate-800 truncate">{pair.a}</p>
                      <p className="text-xs text-slate-400 mt-0.5 flex items-center gap-1">
                        <ArrowRight className="w-3 h-3" />
                        pairs with
                      </p>
                      <p className="text-sm font-medium text-slate-800 truncate">{pair.b}</p>
                    </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">What your routine might be missing</p>
              </div>
            </div>
          </CardHeader>
          <CardBody>
              ...
              <ul className="space-y-3">
                {routineGaps.map((gap, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-slate-700 pt-0.5">{gap}</p>
                  </li>
                ))}
              </ul>
            )}
